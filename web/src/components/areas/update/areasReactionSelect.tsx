...
export default function AreasReactionSelect({ leftValue, onLeftChange, rightValue, onRightChange, onParamsChange, initialParams = {}}: AreasReactionSelectProps) {
            ...
            {leftValue && rightValue && (
                <div className="col-span-1 md:col-span-3">
                    ...
                    {!paramsLoading && !paramsError && paramsData?.params?.length === 0 && (
                        <p>No parameters required for this reaction.</p>
                    )}
